      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div className="space-y-16">
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8">Onde nos <span className="italic font-serif">Encontrar</span></h2>
        ...
        <div className="relative group">
          ...
          <div className="h-[350px] md:h-full min-h-[350px] md:min-h-[500px] rounded-[3rem] overflow-hidden shadow-2xl relative border border-white/10">
            <iframe 
