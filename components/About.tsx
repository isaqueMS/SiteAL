...
const About: React.FC = () => {
  return (
    <section id="sobre" className="py-16 md:py-32 bg-[#121212]">
        ...
        <div className="order-1 lg:order-2 space-y-10">
          ...
          <div className="space-y-6">
            <p className="text-stone-400 text-lg font-light leading-relaxed">
              O <strong>Studio Alesandra Sena</strong> é mais que um salão; é um refúgio de autocuidado em Salvador. Há {SALON_DATA.yearsActive} anos, somos referência em <strong>Alongamento Mega Hair</strong> e <strong>Alisamentos</strong>, elevando o padrão da estética com foco na saúde capilar.
            </p>
            <p className="text-stone-500 font-light">
              Localizado em Castelo Branco, nosso estúdio combina especialização técnica com um ambiente que exala modernidade. Aqui, transformamos cabelos e unhas em verdadeiras obras de arte.
            </p>
          </div>
