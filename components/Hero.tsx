      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <p className="text-stone-400 text-base md:text-xl max-w-xl font-light leading-relaxed">
              Referência em <span className="text-white font-semibold">Alongamento Mega Hair</span>, <span className="text-white font-semibold">Alisamentos</span> e <span className="text-white font-semibold">Nails de Luxo</span>. Transformamos sua autoestima com técnicas exclusivas.
            </p>
