...
export const SALON_DATA = {
  ...
  differentiation: "Especialização em Alongamento Mega Hair, Alisamentos e Spa dos Pés com atendimento personalizado."
};
...
export const SERVICES: Service[] = [
  ...
  // Hair
  { name: "Alongamento Mega Hair", category: 'Hair' },
  { name: "Alisamento Progressivo", category: 'Hair' },
